...
function utru_enqueue_comments_reply() {
    if (get_option('thread_comments')) wp_enqueue_script('comment-reply');
}
add_action('comment_form_before', 'utru_enqueue_comments_reply');
 ...
 * a custom home page.
 */
function utru_title_for_home($title) {
...
add_filter('wp_title', 'utru_title_for_home');

/*
 * Alters formatting of excerpt_more
 * Default is [...]
 */
function utru_excerpt_more($more) {
    return '&hellip;';
}
add_filter('excerpt_more', 'utru_excerpt_more');
